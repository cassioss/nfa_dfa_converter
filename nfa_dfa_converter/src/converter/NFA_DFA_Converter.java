...
public class NFA_DFA_Converter {
	...
	/* Cálculo de eclose para o caso geral - método de referência */
	...
	/* Dada uma string, verificar então se ela é o início de um DFA ou não */
	...
	/* Dada uma string, verificar então se ela é o final de um DFA ou não */
	...
	/*
	 * Determinar o conjunto de estados atingidos numa transição de um
	 * determinado símbolo
	 */
	...
	/*
	 * Determina os estados atingidos por uma determinada transição
	 * iterativamente
	 */
	...
	/* Início da determinação acima, partindo do estado inicial da DFA */
	...
	/* Construção efetiva do DFA a partir de um NFA */
	...
	protected static String[] nome_coluna1 = { "Estado", "épsilon", "a", "b",
			"c" };
	...
	public static void main(String args[]) {
		...
		gui1.setTitle("Tabela de transições do épsilon-NFA 3");  //1, 2, 3
		gui2.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		gui2.setSize(600, 180);
		gui2.setVisible(true);
		gui2.setTitle("Tabela de transições do DFA 3");   //1, 2, 3
